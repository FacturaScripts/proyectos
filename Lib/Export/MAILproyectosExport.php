...
use FacturaScripts\Dinamic\Lib\Export\PDFproyectosExport;

/**
 * Genera el PDF del proyecto y redirige a SendMail para adjuntarlo al enviarlo por email.
 *
 * @author Daniel Fernández Giménez <contacto@danielfg.es>
 */
class MAILproyectosExport extends PDFproyectosExport
{
    /** @var array */
