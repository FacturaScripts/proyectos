...
use FacturaScripts\Dinamic\Lib\Export\PlantillasPDFproyectosExport;

/**
 * Genera el PDF del proyecto con la plantilla de PlantillasPDF y redirige a SendMail para
 * adjuntarlo al enviarlo por email.
 *
 * @author Daniel Fernández Giménez <contacto@danielfg.es>
 */
class PlantillasMAILproyectosExport extends PlantillasPDFproyectosExport
{
    /** @var array */
